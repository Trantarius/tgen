...
@export_range(0,1,0) var land_minor_opacity:float = 0.25:
	get:
...
@export var water_show:bool = true:
	...
	set(to):
		$Water.visible=to
@export_range(0,1,0,"or_less","or_greater") var water_min_value:float = 0.0:
	get:
		return $Water.material.get_shader_parameter("min_value")
	set(to):
		$Water.material.set_shader_parameter("min_value",to)
@export_range(0,1,0,"or_less","or_greater") var water_max_value:float = 1.0:
	get:
...
@export var sediment_show:bool = true:
	...
	set(to):
		$Sediment.visible=to
@export_range(0,1,0,"or_less","or_greater") var sediment_min_value:float = 0.0:
	get:
		return $Sediment.material.get_shader_parameter("min_value")
	set(to):
		$Sediment.material.set_shader_parameter("min_value",to)
@export_range(0,1,0,"or_less","or_greater") var sediment_max_value:float = 1.0:
	get:
